...
export default {
  ...
  activate () {
    ...
    this.disposables.add(atom.commands.add('atom-text-editor:not([mini])', {
      'super-select:chars-1' : () => this.selectMany(this.byChar, '[0-9\\p{L}_\\.]'),
      'super-select:chars-1+': () => this.selectMany(this.byChar, '[0-9\\p{L}_\\.\\[\\]]'),
      'super-select:chars-2' : () => this.selectMany(this.byChar, '[0-9\\p{L}_\\.-]'),
      'super-select:chars-3' : () => this.selectMany(this.byChar, '[0-9\\p{L}\\\\]'),
      'super-select:chars-4' : () => this.selectMany(this.byChar, '[0-9a-zA-Z_\\[\\]#]'),
      ...
      'super-select:html-body'       : () => this.selectMany(this.htmlBody.bind(this)),
      'super-select:html-tags'       : () => this.selectMany(this.htmlTags.bind(this)),
    }))
